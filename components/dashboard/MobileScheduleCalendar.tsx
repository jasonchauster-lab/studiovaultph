        ...
        <div className="flex flex-col h-full bg-off-white/50 font-sans antialiased text-charcoal">
            ...
            <div className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-border-grey/60 px-4 pt-5 pb-3 shadow-tight">
                <div className="flex items-center justify-between mb-4 sm:mb-5">
                    ...
                    <div className="flex bg-off-white/50 backdrop-blur-sm rounded-full p-0.5 border border-border-grey/60">
                        ...
                        <button
                            ...
                            className="px-2 sm:px-3 py-1 text-[7px] sm:text-[8px] font-black text-charcoal uppercase tracking-[0.2em] sm:tracking-[0.3em]"
                        >
                            Today
                        </button>
                        <button
                ...
                <div className="grid grid-cols-2 gap-2 sm:gap-3 mb-4 sm:mb-6">
                    <button
                        ...
                        className="flex items-center justify-center gap-2 py-2.5 sm:py-3 bg-forest text-white rounded-lg sm:rounded-xl text-[9px] sm:text-[10px] font-black uppercase tracking-[0.2em] shadow-card active:scale-95 transition-all"
                    >
                        <Plus className="w-3.5 h-3.5 sm:w-4 sm:h-4 stroke-[3px]" /> Add Slot
                    </button>
                    {onRecurringSchedule && (
                        <button
                            onClick={() => onRecurringSchedule()}
                            className="flex items-center justify-center gap-2 py-2.5 sm:py-3 bg-white text-charcoal border border-border-grey/50 rounded-lg sm:rounded-xl text-[9px] sm:text-[10px] font-black uppercase tracking-[0.2em] shadow-tight active:scale-95 transition-all"
                        >
                            <CalendarIcon className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-forest" /> Recurring
                        </button>
                    )}
                </div>
            ...
            <div ref={agendaRef} className="flex-1 overflow-y-auto px-4 py-6 space-y-4 scroll-smooth">
                ...
                {agendaSessions.length > 0 ? (
                                ...
                                >
                                    ...
                                    <div className="flex justify-between items-start gap-3">
                                        <div className="space-y-2 flex-1 min-w-0">
                                            <div className={clsx("flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.2em]", session.is_booked ? "text-white/50" : "text-charcoal/30")}>
                    ...
                    <div className="flex flex-col items-center justify-center py-12 sm:py-16 text-center bg-white rounded-2xl border border-border-grey/50 shadow-tight relative overflow-hidden group">
                        <div className="absolute inset-0 bg-gradient-to-b from-buttermilk/5 to-transparent pointer-events-none" />
                        <div className="w-12 h-12 sm:w-14 sm:h-14 bg-off-white rounded-full flex items-center justify-center border border-border-grey/50 shadow-tight mb-4 sm:mb-5 relative z-10 group-hover:scale-110 transition-transform duration-700">
                            <CalendarIcon className="w-5 h-5 sm:w-6 sm:h-6 text-burgundy/40" />
                        </div>
                        <h3 className="text-[9px] sm:text-[10px] font-black text-burgundy uppercase tracking-[0.3em] sm:tracking-[0.4em] mb-1.5 sm:mb-2 relative z-10">Rest Day</h3>
                        <p className="text-[7px] sm:text-[8px] font-black text-charcoal/50 uppercase tracking-[0.2em] max-w-[150px] sm:max-w-[180px] relative z-10 leading-relaxed">No sessions scheduled for this day.</p>
                    </div>
                )}
            </div>
