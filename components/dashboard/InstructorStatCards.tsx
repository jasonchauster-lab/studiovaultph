    ...
    return (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            {cardData.map((card, index) => (
                <div key={index} className="glass-card p-8 group relative overflow-hidden transition-all duration-700 hover:-translate-y-2">
                    {/* Soft Bloom */}
                    <div className={clsx(
                    ...
                    <div className="flex justify-between items-start mb-8">
                        <div className={clsx(
                            "p-4 rounded-[12px] group-hover:scale-110 transition-all duration-700 border border-white/60 shadow-sm",
                            card.bgIcon
                        )}>
                    ...
                    {card.hasAction && (
                        <div className="mt-8 pt-8 border-t border-white/60">
                            <Link
                                ...
                                className="w-full h-14 bg-charcoal text-white rounded-[12px] text-[10px] font-black uppercase tracking-[0.3em] flex items-center justify-center gap-3 hover:brightness-[1.2] transition-all shadow-md active:scale-95"
                            >
