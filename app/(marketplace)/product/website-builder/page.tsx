    ...
    return (
        <div className="min-h-screen bg-white selection:bg-forest/10 selection:text-forest overflow-x-hidden font-atelier">
            ...
            <nav className={`fixed top-0 left-0 right-0 z-[100] transition-all duration-500 border-b ${
                scrolled 
                ? 'bg-white/90 backdrop-blur-2xl border-cream-100 py-5' 
                ...
                <div className="max-w-7xl mx-auto px-6 relative z-10 w-full flex flex-col lg:flex-row items-center gap-16 md:gap-24">
                    <div className="flex-1 space-y-10 text-center lg:text-left">
                        ...
                        >
                            ...
                            <Link 
                                href="#pricing" 
                                className="bg-white/10 text-white border border-white/20 backdrop-blur-xl px-10 py-5 rounded-2xl text-[11px] font-black uppercase tracking-[0.3em] hover:bg-white/20 transition-all flex items-center justify-center gap-3"
                            >
                                Learn More
                            </Link>
                        </motion.div>
                    ...
                    >
                        <div className="relative z-10 w-full max-w-[500px] mx-auto perspective-1000">
                            <motion.div
                                ...
                                className="relative bg-white/5 border-4 border-white/10 rounded-[3rem] overflow-hidden shadow-[0_50px_100px_rgba(0,0,0,0.5)] aspect-[4/5] lg:aspect-auto"
                            >
                                <Image 
            ...
            {/* Verticals Slideshow - "One Platform. Every Studio." Section */}
            <section className="py-24 md:py-48 px-6 bg-white overflow-hidden border-b border-cream-100">
                <div className="max-w-7xl mx-auto space-y-24">
                    <div className="text-center space-y-8">
                        <h2 className="text-5xl md:text-8xl font-serif !text-charcoal leading-tight tracking-tighter">
                            One Platform. <br />
                            <span className="italic">Every Studio.</span>
                        </h2>
                        <p className="text-lg md:text-xl text-slate/60 font-light max-w-2xl mx-auto">
                            Whether you're finding zen or throwing punches, StudioVault adapts to your unique rhythm. 
                            Our platform is built to scale with your specific niche.
                        </p>
                    </div>

                    {/* Horizontal Progress Tabs */}
                    <div className="flex flex-wrap md:flex-nowrap justify-center gap-4 md:gap-8 border-b border-cream-100 pb-12">
                        {industries.map((v, i) => (
                            <button
                                key={v.id}
                                onClick={() => {
                                ...
                                className="group relative py-4 px-6 text-center space-y-3 transition-all min-w-[120px]"
                            >
                                <span className={`text-[10px] font-black uppercase tracking-[0.2em] transition-colors ${
                                    activeIndex === i ? 'text-forest' : 'text-slate/30 group-hover:text-slate'
                                }`}>
                                    {v.label}
                                </span>
                                
                                <div className="h-1 w-full bg-cream-100 rounded-full overflow-hidden relative">
                                    <motion.div 
                                        key={activeIndex === i ? 'active' : 'inactive'}
                                        initial={{ width: 0 }}
                                        animate={{ width: activeIndex === i ? '100%' : '0%' }}
                                        transition={{ 
                                            duration: activeIndex === i ? 5 : 0, 
                                            ease: "linear" 
                                        }}
                    ...
                    {/* Sliding Mockup Gallery */}
                    <div className="relative h-[400px] md:h-[700px] w-full overflow-hidden rounded-[3rem]">
                        <motion.div 
                        ...
                        >
                            {industries.map((v) => (
                                <div key={v.id} className="min-w-full h-full relative px-4">
                                    <div className="relative h-full w-full bg-white rounded-[2.5rem] shadow-[0_40px_100px_rgba(0,0,0,0.05)] border-4 border-cream-100 overflow-hidden group">
                                        <Image 
                                            src={v.mockupImage}
                                            alt={v.title}
                                            fill
                                        ...
                                        />
                                        <div className="absolute inset-0 bg-gradient-to-t from-charcoal/60 via-charcoal/20 to-transparent flex flex-col justify-end p-8 md:p-20 text-center md:text-left">
                                            <div className="space-y-4 max-w-xl">
                                                <h3 className="text-3xl md:text-6xl font-serif text-white tracking-tight leading-none">
                                                    {v.title}
                                                </h3>
                ...
                <div className="max-w-7xl mx-auto mt-32 relative px-4 text-left">
                    ...
                    >
                         <Image 
                            ...
                            width={1200}
                            height={800}
                            className="rounded-[2.5rem] shadow-[0_120px_150px_rgba(0,0,0,0.6)] border-8 border-white/5 mx-auto"
                        />
                    </motion.div>
                ...
                <div className="max-w-7xl mx-auto space-y-24">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-5xl mx-auto">
                        ...
                        <div className="bg-white rounded-[40px] p-12 border border-cream-200 shadow-sm flex flex-col space-y-12 hover:border-forest/30 transition-all group lg:scale-95">
                            ...
                            <Link href="/pricing" className="w-full py-6 rounded-2xl bg-[#f0f0f0] text-charcoal text-[11px] font-black uppercase tracking-[0.3em] text-center hover:bg-cream-100 transition-all font-black">
                                Select Starter
                            </Link>
                        </div>
                        ...
                        <div className="bg-[#1b1c19] rounded-[40px] p-12 border border-white/10 shadow-[0_50px_100px_rgba(0,0,0,0.3)] flex flex-col space-y-12 relative overflow-hidden group">
                            ...
                            <Link href="/pricing" className="relative z-10 w-full py-6 rounded-2xl bg-forest text-white text-[11px] font-black uppercase tracking-[0.3em] text-center hover:brightness-110 transition-all shadow-xl font-black">
                                Upgrade to Pro
                            </Link>
            ...
            <footer className="py-24 px-6 bg-[#1b1c19] border-t border-white/5">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-12">
                    <div className="space-y-4 text-center md:text-left">
                        <Image src="/logo4.png" alt="StudioVault" width={160} height={48} className="h-10 w-auto brightness-0 invert opacity-50 mx-auto md:mx-0" />
