-- Migration: 20260415_update_booking_atomic_for_partitioned_wallets.sql
...
CREATE OR REPLACE FUNCTION public.book_slot_atomic(
    ...
    p_use_studio_wallet BOOLEAN = FALSE -- Added to support partitioned wallets
)
RETURNS JSONB
LANGUAGE plpgsql
SECURITY DEFINER
